// src/pages/doctor/Notifications.tsx
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    switch (notification.targetType) {
      case 'appointment':
        ...
        break;
      case 'test_result':
        navigate(`/doctor/test-results-review?testResultId=${notification.targetId}`);
        break;
      case 'encounter':
        navigate(`/doctor/patient-profile/${notification.metadata?.patientId || ''}?encounterId=${notification.targetId}`);
        break;
      case 'patient':
        navigate(`/doctor/patients?patientId=${notification.targetId}`);
        break;
      default:
        break;
    }
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              ...
              <option value={NotificationType.PATIENT_ASSIGNED}>Patient Allocation</option>
            </select>
          </div>
        </div>
